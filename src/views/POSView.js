...
const POSView = ({ products, cart, addToCart, updateQuantity, total, handleCheckout, syncStatus }) => {
  return (
    <>
      {/* Daftar Produk */}
      <div className="w-3/5 bg-white rounded-lg shadow p-4">
        <h2 className="text-2xl font-bold mb-4">Produk</h2>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 overflow-y-auto h-[calc(100vh-120px)]">
          {products?.map(p => (
